...
<div className="form-group">
    ...
    onChange={this.onChangeName} placeholder="Name" minLength="2" maxLength="20" size="20"/>
        </div>
        <div className="form-group">
        <label htmlFor="password">Password:</label>
    <input type="password" className="form-control" name="password"
    value={this.state.password}
    onChange={this.onChangePassword} placeholder="Password" minLength="2" maxLength="20" size="20"/>
        </div>
